    ...
    font.load(() => {
        app.get("/:name", (req, res) => {
            ...
            ctx.drawImage(
                ...
                0,
                0,
                img.width, img img.height, // source dimensions
                350 - img.width / 4,
                20,
                img.width / 2,
                img.height / 2 // destination dimensions
            );

            PImage.encodePNGToStream(img1, res)
                .then(() => {})
                .catch((e) => {});
        });
        monitor.bronbro.io / d / juno - stats / juno - stats ? orgId = 2 & refresh = 5 s
